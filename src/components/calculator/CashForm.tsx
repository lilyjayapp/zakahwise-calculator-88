  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-zakah-primary mb-4">Cash & Bank Balances</h2>
      ...
      <div className="space-y-6 max-w-md mx-auto">
        <div className="space-y-2">
          <Label htmlFor="cashAmount" className="text-xl font-semibold">Total Cash Amount</Label>
