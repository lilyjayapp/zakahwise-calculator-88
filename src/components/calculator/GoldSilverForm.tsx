  ...
  return (
    <div className="space-y-4">
      <div className="text-center mb-4">
        <h2 className="text-lg font-semibold text-zakah-primary">Gold & Silver</h2>
        <p className="text-xs text-gray-600">Enter the monetary value of your gold and silver holdings.</p>
      </div>
